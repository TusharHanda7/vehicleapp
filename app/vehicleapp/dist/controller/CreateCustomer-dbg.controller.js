sap.ui.define([
	...
	return Controller.extend("vehicleapp.ui.vehicleapp.controller.CreateCustomer", {
		// formatter: formatter,
		/**
		...
		onSwitchAddVehicle: function(oEvent) {
			...
			if (State) {
				if (!this.AddVehicleToCustomer) {
					this.AddVehicleToCustomer = sap.ui.xmlfragment("vehicleapp.ui.vehicleapp.fragment.TagVehicleToCustomer", this); // Fragments for Process select
